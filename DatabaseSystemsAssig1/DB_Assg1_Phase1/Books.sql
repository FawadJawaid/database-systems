...
CREATE TABLE Bidding Process (
  ...
  INDEX Bidding Process_FKIndex1(Book_Title),
...
CREATE TABLE Book_Shipment_Through_Private Courier (
  ...
  PRIMARY KEY(Book_Title, Private Courier_Courier ID),
  INDEX Book_has_Private Courier_FKIndex1(Book_Title),
...
CREATE TABLE Regular Process (
  ...
  INDEX Regular Process_FKIndex1(Book_Title)
);
...
CREATE TABLE Searching Process (
  ...
  INDEX Searching Process_FKIndex1(Book_Title)
);
